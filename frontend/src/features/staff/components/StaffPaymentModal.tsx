    ...
    <Modal open onClose={onClose} ariaLabelledBy="payment-modal-title">
      <div className="w-full p-0">
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            <p className="text-sm text-content-muted">Table</p>
            <h2 id="payment-modal-title" className="text-2xl font-semibold">
              Payment — Table {String(tableNumber).padStart(2, '0')}
            </h2>
          </div>
        ...
        <div className="mt-5 space-y-4 border-t border-border pt-4">
          <div>
            <label className="mb-1 block text-sm text-content-muted">Payment method</label>
          ...
          <div className="grid grid-cols-1 gap-3">
            <label>
              <span className="mb-1 block text-sm text-content-muted">Waste boxes ($6 each)</span>
            ...
            <label>
              <span className="mb-1 block text-sm text-content-muted">Tip amount</span>
          ...
          <div className="space-y-2 rounded-xl bg-surface-raised p-4">
            ...
            <div className="flex justify-between text-sm text-content-muted">
              <span>Waste ({wasteBoxes} boxes)</span>
              <span>{money(wasteTotal)}</span>
            </div>
          ...
          >
            {isSaving ? 'Saving payment...' : 'Confirm payment and close table'}
          </Button>
        </div>
      </div>
    </Modal>
