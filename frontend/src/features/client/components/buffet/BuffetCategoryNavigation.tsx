// frontend/src/features/client/components/buffet/BuffetCategoryNavigation.tsx
...
type BuffetCategoryNavigationProps = {
...
export function BuffetCategoryNavigation({
  stations,
  activeCategory,
  navigationRef,
  onSelectCategory,
}: BuffetCategoryNavigationProps) {
